    ...
    'imageAttributes': function (context) {
      ...
      if (options.imageAttributes.disableUpload == false) {
        ...
        body +=    '  <div class="tab-pane note-tab-pane fade in active" id="note-imageAttributes' + timestamp + '">' +
                   ...
                   '      <div class="input-group note-input-group col-xs-12 col-sm-9">' +
                   '        <input class="note-imageAttributes-src form-control note-form-control note-input" list="imageList" type="text" />' +
          ...
          ui.onDialogShown(self.$dialog, function () {
            ...
            $editBtn.click( function (e) {
              ...
              deferred.resolve({
                ...
                src:        (($imageSrc.val() == $imageSrc.val().split('/').reverse()[0])?baseurlis+$imageSrc.val():$imageSrc.val()),
                alt:        $imageAlt.val(),
