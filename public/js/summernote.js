...
$$1.extend($$1.summernote.lang, {
    'en-US': {
		...
		'nl-NL': {
			...
			imageAttributes:{
				dialogTitle: 'Afbeelding eigenschappen',
				tooltip: 'Afbeelding eigenschappen',
				tabImage: 'Afbeelding',
				src: 'bron',
				browse: 'Zoeken',
				title: 'Titel',
				...
				tabAttributes: 'Attributen',
				class: 'Class',
				style: 'Stijl',
				role: 'Rol',
				tabLink: 'Link',
				linkHref: 'URL',
				linkTarget: 'Besteming (doel)',
				linkTargetInfo: 'Opties: _self, _blank, _top, _parent',
				linkClass: 'Class',
				linkStyle: 'Stijl',
				linkRel: 'Verbindingsrelatie (relatie)',
				linkRelInfo: 'Opties: alternate, author, bookmark, help, license, next, nofollow, noreferrer, prefetch, prev, search, tag',
				linkRole: 'Rol',
				tabUpload: 'Uploaden',
				upload: 'Upload',
				tabBrowse: 'Zoeken',
			...
			image: {
				...
				maximumFileSize: 'Maximum file size',
				maximumFileSizeError: 'Maximum file size exceeded.',
				url: 'Geef de naam van de afbeelding',
...
function createImage(url) {
		if(url == url.split('/').reverse()[0]){url = baseurlis+url;}
    return $$1.Deferred(function (deferred) {
        var $img = $$1('<img>');
    ...
    function Editor(context) {
        ...
        this.createLink = this.wrapCommand(function (linkInfo) {
            ...
            if (_this.options.onCreateLink) {
                ...
                linkUrl = (linkUrl.replace(/\/?[^A-Za-z0-9_\-+]*/g, '')==linkUrl
								|| ("/"+linkUrl.replace(/\/?[^A-Za-z0-9_\-+]*/g, ''))==linkUrl
								|| (linkUrl.replace(/\/?[^A-Za-z0-9_\-+]*/g, '')+"/")==linkUrl
								|| ("/"+linkUrl.replace(/\/?[^A-Za-z0-9_\-+]*/g, '')+"/")==linkUrl)
...
var ImageDialog = /** @class */ (function () {
    ...
    ImageDialog.prototype.initialize = function () {
        ...
        var body = [
            ...
            ' col-md-12" list="imageList" type="text" />',
            '</div>'
        ].join('');
